...
=== link:https://semver.org[Version]: 1.0.5

=== Gültig ab: FS 2026 (1.2.2026)
...
| Kompetenznachweis
a| Teil 1: Projektabgabe mit Zwischenergebnissen (Agile Rituale, Deliverables, Abschlusspräsentation) als Gruppenarbeit mit gemeinsamer Note (50%) in den Semesterwochen:
