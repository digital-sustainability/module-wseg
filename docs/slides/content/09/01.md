...
https://gitlab.ti.bfh.ch/dsl-student-projects/wseg-25-fs/sandbox/

- Bitte [sandbox](https://gitlab.ti.bfh.ch/dsl-student-projects/wseg-25-fs/sandbox/) nach abcd1 forken
...
### 3. Deliverable (15. Mai)

[Issue-Vorlage](https://github.com/digital-sustainability/module-wseg/blob/25/fs/docs/tasks.md#%EF%B8%8F-iteration-3) wird verschickt..
...
- #10 Software Testing / CI-Pipeline Teil 2 (MT)
- #11 Cloudbasierte Software, Closing DevOps
  - Wrap-up #3
  - Qualitätskriterien Praxisprojekt
- #12 Projektabschluss / Software Testing (JB)
