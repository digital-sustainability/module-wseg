...
[Source](https://gitlab.ti.bfh.ch/w-wseg/module/-/tree/26/hs/docs/slides/content/03-web-frontend) licensed under [CC-BY-4.0](https://gitlab.ti.bfh.ch/w-wseg/module/-/blob/26/hs/LICENSE)
...
### Vorschau <a href="https://gitlab.ti.bfh.ch/w-wseg/module/-/blob/26/hs/docs/tasks.md?ref_type=heads#deliverables">Deliverable 1</a>
