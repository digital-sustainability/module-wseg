...
- Merge Request
- Blogbeitrag im Markdown-Format (🧠: KI höchstens zum Umformulieren)
- Erstes Datenmodell als ER-Diagramm
- [Issue folgt für 3. November](https://github.com/digital-sustainability/module-wseg/blob/25/hs/docs/tasks.md#%EF%B8%8F-iteration-2)
