...
---
3 - (beste) Plattformen MVPs (+ Spektrum) der letzten Semester als Referenz
---
* 4 - Rahmen / Lehre vorstellen _ W-Fragen / Agilität? Auto-Transition per (https://revealjs.com/#/7)
	* Preview / Einblick
	* inhaltlicher roter Faden (GitLab DevOps) + API 1:47min (What is an API (in 5 minutes) [ByGJQzlzxQg]) + Agilität UML / Vorgehensmodell
	* Ziel
---
* 4 - Prinzipien (Offenheit, Walk-The-Talk, Kaizen: kontinuierliche Verbesserung)
---
