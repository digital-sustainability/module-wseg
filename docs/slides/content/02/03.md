...
git clone git@gitlab.ti.bfh.ch:dsl-student-projects/wseg-25-fs/sandbox.git
git clone https://gitlab.ti.bfh.ch/dsl-student-projects/wseg-25-fs/sandbox.git
```
