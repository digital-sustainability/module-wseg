...
[Source](https://gitlab.ti.bfh.ch/w-wseg/module/-/tree/26/fs/docs/slides/content/06-api-ts) licensed under [CC-BY-4.0](https://gitlab.ti.bfh.ch/w-wseg/module/-/blob/26/fs/LICENSE)
...
- Datenmodell (als [Bruno-Collection](https://gitlab.ti.bfh.ch/w-wseg/26-fs/sandbox/-/tree/main/backend/bruno?ref_type=heads))
- Blog-Text im Markdownformat

Termin 23. April: [Issue folgt heute](https://gitlab.ti.bfh.ch/w-wseg/module/-/blob/26/fs/docs/tasks.md?ref_type=heads#%EF%B8%8F-iteration-2)
...
- Demonstration: https://gitlab.ti.bfh.ch/w-wseg/26-fs/sandbox/-/issues/35
