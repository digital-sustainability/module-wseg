...
2. Angular ist **nicht prüfungsrelevant**
...
### Erweiterung für Angular (aus Folge 2) 💡

Angular Language Service für [VSCode](https://marketplace.visualstudio.com/items?itemName=Angular.ng-template)
